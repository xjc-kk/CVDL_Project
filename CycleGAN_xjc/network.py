'''
This file defines some useful layers used in the G and D models
...
def get_norm_layer(norm_type='instance'):
    '''
    return batch normalization or instance normalization
    '''
    if norm_type == 'batch':
...
def set_grad(nets, requires_grad=False):
    '''
    set the gradients of all parameters in the network
    '''
    for net in nets:
