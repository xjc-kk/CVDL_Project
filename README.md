...
We don't include the training data in the submitted file since it takes too much space, if the TA needs the training data to test our code, please contact us.